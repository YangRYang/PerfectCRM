...
class CustomerFollowUp(models.Model):
    ...
    user = models.ForeignKey("UserProfile",verbose_name="跟进人",on_delete=models.SET_NULL,null=True)
...
class CourseRecord(models.Model):
    """上课记录"""
    class_grade = models.ForeignKey("ClassList",verbose_name="上课班级",on_delete=models.SET_NULL,null=True)
...
class StudyRecord(models.Model):
    """学习记录表"""
    course_record = models.ForeignKey("CourseRecord",on_delete=models.SET_NULL,null=True)
